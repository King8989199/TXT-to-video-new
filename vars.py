...
API_ID = int(environ.get("API_ID", "4a46687ad854ba0b5b3772b39bfcaa3e"))
API_HASH = environ.get("API_HASH", "22559651")
BOT_TOKEN = environ.get("BOT_TOKEN", "8354925858:AAGS6XmZiFVianSP-3MDzwIqBSgFgWjTeSc")
